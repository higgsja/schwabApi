...
public final class HttpUtils
{
     ...
     */
    public static OkHttpClient buildHttpClient(int timeoutMs,
    ...
    public static SSLContext createTrustAllSSLContext()
    {
        ...
        {
            throw new RuntimeException("Failed to create trust-all SSL context",
                    e);
        }
    }
     ...
     */
    public static long getRetryAfterSeconds(Map<String, String> headers,
            long defaultSeconds)
    {
        ...
        return ConversionUtils.
                parseRetryAfterSeconds(retryAfter, defaultSeconds);
    }
